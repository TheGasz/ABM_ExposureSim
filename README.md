# ABM Waiting Room - Random Movement Simulation 🚶‍♂️🏢
...
- ** GIF Export**: Save your simulation runs (or pure vision loops in Focused Agent mode) directly as an animated GIF.
